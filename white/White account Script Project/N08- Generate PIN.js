function generateDurationAlgoPinRenaultTrafic2(rowData, rowIndex, sheet) {
  ...
  var deviceId = 'IGK32298e527'; // Renault Trafic 2 ID
  ...
  updateEventWithPinRenaultTrafic2(rowData, pinData.pin);
}

function updateEventWithPinRenaultTrafic2(rowData, pin) {
  var vehicleType = 'N08 - Renault Trafic (Lugano)'; // Ensure this matches your vehicleConfigs
  ...
  if (matchingEvent) {
    ...
    var newMessage = rentalDetails + locationDetails +
      ...
      "- \uD83C\uDD7F\uFE0F Parcheggiare nel posteggio *No° 19*, rispettando le linee\n" +
