function generateDurationAlgoPinCitroenJumper3(rowData, rowIndex, sheet) {
  ...
  var deviceId = 'IGK331c318e6'; // Citroen JUmper L2H2 device ID
  ...
  updateEventWithPinCitroenJumper3(rowData, pinData.pin);
}

function updateEventWithPinCitroenJumper3(rowData, pin) {
  var vehicleType = 'N11 - Citroen Jumper L1H1 (Losone)';
  ...
  if (matchingEvent) {
    ...
    var newMessage = rentalDetails + locationDetails +
      ...
      "- \uD83C\uDD7F\uFE0F Parcheggiare nel posteggio *No° 3*, rispettando le linee\n" +
