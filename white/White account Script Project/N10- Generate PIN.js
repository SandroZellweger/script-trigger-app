function generateDurationAlgoPinCitroenJumper2(rowData, rowIndex, sheet) {
  ...
  var deviceId = 'IGK323964023'; // Citroen JUmper L2H2 device ID
  ...
  updateEventWithPinCitroenJumper2(rowData, pinData.pin);
}

function updateEventWithPinCitroenJumper2(rowData, pin) {
  var vehicleType = 'N10 - Citroen Jumper (Losone)';
  ...
  if (matchingEvent) {
    ...
    var newMessage = rentalDetails + locationDetails +
      ...
      "- \uD83C\uDD7F\uFE0F Parcheggiare nel posteggio *No° 1*, rispettando le linee\n" +
