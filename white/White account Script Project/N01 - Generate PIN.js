function generateDurationAlgoPinVivaro(rowData, rowIndex, sheet) {
  ...
  var deviceId = 'IGK32067b80d'; // Vivaro device ID
  ...
  updateEventWithPinVivaro(rowData, pinData.pin);
}

function updateEventWithPinVivaro(rowData, pin) {
  var vehicleType = 'N01 - Opel Vivaro (Losone)';
  ...
  if (matchingEvent) {
    ...
    var newMessage = rentalDetails + locationDetails +
      ...
      "- \uD83C\uDD7F\uFE0F Parcheggiare nel posteggio *No° 2*, rispettando le linee\n" +
