function generateDurationAlgoPinRenaultTrafic3(rowData, rowIndex, sheet) {
  ...
  var deviceId = 'IGK322bd6b60'; // RTL1H1 device ID
  ...
  updateEventWithPinRenaultTrafic3(rowData, pinData.pin);
}

function updateEventWithPinRenaultTrafic3(rowData, pin) {
  var vehicleType = 'N09 - Renault Trafic (Caslano)';
  ...
  if (matchingEvent) {
    ...
    var newMessage = rentalDetails + locationDetails +
      ...
      "- \uD83C\uDD7F\uFE0F Parcheggiare nel posteggio tutto a sinistra, rispettando le linee\n" +
