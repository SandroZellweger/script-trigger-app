function generateDurationAlgoPinBoxer(rowData, rowIndex, sheet)  {
  ...
  var deviceId = 'IGK320e54802'; // peugot Boxer
  ...
  updateEventWithPinBoxer(rowData, pinData.pin);
}


function updateEventWithPinBoxer(rowData, pin) {
  var vehicleType = 'N03 - Peugeot Boxer (Bellinzona)'; // Ensure this matches your vehicleConfigs
  ...
  if (matchingEvent) {
    ...
    var rentalDetails = `*N03 Peugeot Boxer (Bellinzona) TI 157778*\n*${Utilities.formatDate(startTime, 'GMT+02:00', 'dd.MM.yy')} / ${Utilities.formatDate(startTime, 'GMT+02:00', 'HH:mm')}-${Utilities.formatDate(endTime, 'GMT+02:00', 'HH:mm')}*\n\n`;

//Bellinzona
    var locationDetails = "\uD83D\uDCCD *Locazione Furgone:* https://maps.app.goo.gl/EGbjdm3RAATrcXKn9\n\n";

//location Quartino:
 //   var locationDetails = "\uD83D\uDCCD *Locazione Furgone:* https://maps.app.goo.gl/SaaVwsWkiRRnw7dCA\n\n";
...
//Location Lugano
    ...
    var newMessage = rentalDetails + locationDetails +
      ...
      "- \uD83C\uDD7F\uFE0F Parcheggiare nel posteggio *No° 24*, rispettando le linee\n" +
